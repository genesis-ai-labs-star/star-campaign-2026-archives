...
gmail_subs = analyze_emails(os.environ['GMAIL_JUNJIE_USER'], os.environ['GMAIL_JUNJIE_ALT_PASSWORD'], "imap.gmail.com")
for s in gmail_subs:
    print(s)

print("\n--- Foxmail Analysis ---")
foxmail_subs = analyze_emails(os.environ['FOXMAIL_USER'], os.environ['FOXMAIL_PASSWORD'], "imap.qq.com")
