...
3. Read `STYLE.md` — this is how you look (Telegram 视觉规范)
...
Capture what matters. ALWAYS use --json filter and --limit lines when reading code or GitHub data to prevent Token Overflow. Decisions, context, things to remember. Skip the secrets unless asked to keep them.
